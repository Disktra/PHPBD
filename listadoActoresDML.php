<html>
    ...
    <body>
        <?php //bootstrap -> estilos.
            ...
            echo "<table>";
            echo "<th><tr><td>Nombre</td><td>Apellidos</td><td>Total</td><td>Hipervinculo</td><td>Modificar</td></tr></th>";
            while($fila = $resultado -> fetch_object())
            {
                ...
                echo "<td><a href = \"formModificarActor.php?actor_id=$fila->ActorId&nombre=$fila->Nombre&apellidos=$fila->Apellidos\">" . "Modificar</a></td>";
                echo "</tr>";
            }
            echo "</table>";
